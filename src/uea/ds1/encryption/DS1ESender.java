...
public class DS1ESender implements Runnable{
    ...
    public DS1ESender(int port, String address, boolean encryption, int key)
    {
        this.port = port;
    ...
    public void run (){
        ...
        while (running){
            try{
                ...
                sending_socket.send(new DatagramPacket(this.encryption ? Utils.encrypt(audioOriginal, this.key) : audioOriginal, audioOriginal.length, clientIP, this.port));
